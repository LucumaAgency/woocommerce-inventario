...
| + | Facturas en el POS de mostrador | ✅ Implementado (v1.25.0) |
| + | Notas de crédito (devoluciones) con aprobación del gerente | ✅ Implementado (v1.26.0) |
| + | Varias empresas emisoras (multi-RUC) | ✅ Implementado (v1.24.0) |
