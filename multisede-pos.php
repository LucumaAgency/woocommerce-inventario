...
require_once MSP_PLUGIN_DIR . 'includes/class-msp-nota.php';
require_once MSP_PLUGIN_DIR . 'includes/class-msp-notas-pantalla.php';
require_once MSP_PLUGIN_DIR . 'includes/class-msp-ticket.php';
require_once MSP_PLUGIN_DIR . 'includes/class-msp-ticket-escpos.php';
...
require_once MSP_PLUGIN_DIR . 'includes/class-msp-factura.php';
require_once MSP_PLUGIN_DIR . 'includes/class-msp-ruc.php';
...
require_once MSP_PLUGIN_DIR . 'includes/class-msp-rest.php';
